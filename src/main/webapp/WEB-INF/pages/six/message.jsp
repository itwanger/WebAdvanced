...
<body class="hold-transition login-page">
	<div class="login-box">
		...
		<div class="login-box-body">
			<p id="login-box-msg" class="login-box-msg"></p>

			<form class="bootstrap-validator" action="${ctx}/six/checkLogin" method="post" data-bv-container="#login-box-msg">
